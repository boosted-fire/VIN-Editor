...
namespace PcmHacking
{
    ...
    {
        VIN_Editor.Main main = new VIN_Editor.Main();
        /// <summary>
        ...
        /// Constructor.
        /// </summary>
        public FileValidator(byte[] image)
        {
            this.image = image;
            //this.logger = logger;
        }
        ...
        public bool IsValid()
        {
            ...
            {
                main.Log("Validating 512k file.");
            }
            else if (this.image.Length == 1024 * 1024)
            {
                main.Log("Validating 1024k file.");
            }
            else
            {
                main.Log(
        ...
        public bool IsSameOperatingSystem(UInt32 pcmOsid)
        {
            ...
            if (pcmOsid == fileOsid)
            {
                main.Log("PCM and file are both operating system " + pcmOsid);
                return true;
            }

            main.Log("Operating system IDs do not match.");
            main.Log("PCM operating system ID: " + pcmOsid);
            main.Log("File operating system ID: " + fileOsid);
            return false;
        }
        ...
        private bool ValidateChecksums()
        {
            ...
            main.Log("\tStart\tEnd\tStored\tNeeded\tVerdict\tSegment Name");
            ...
            for (UInt32 segment = 0; segment < 8; segment++)
            {
                ...
                {
                    main.Log("Checksum table is corrupt.");
                    return false;
                }
        ...
        private bool ValidateSignatures()
        {
            ...
            {
                main.Log("This file does not contain the expected signature at 0x1FFFE.");
                return false;
            }
            ...
            if (image.Length == 512 * 1024)
            {
                ...
                {
                    main.Log("This file does not contain the expected signature at 0x7FFFE.");
                    return false;
                }
            }
            else if (image.Length == 1024 * 1024)
            {
                ...
                {
                    main.Log("This file does not contain the expected signature at 0xFFFFE.");
                    return false;
                }
            }
            else
            {
                main.Log("Files of size " + image.Length.ToString("X8") + " are not supported.");
                return false;
            }
        ...
        {
            main.Log("\tStart\tEnd\tResult\tFile\tActual\tContent");
        }
